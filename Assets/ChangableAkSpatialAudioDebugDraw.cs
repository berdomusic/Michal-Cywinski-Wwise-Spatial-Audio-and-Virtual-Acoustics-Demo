...
public class ChangableAkSpatialAudioDebugDraw : UnityEngine.MonoBehaviour
{
#if UNITY_EDITOR
	...
	private void DrawingActivation()
	{ 
		if (Input.GetKeyDown(KeyCode.F1))
		{
			drawFirstOrderReflections = !drawFirstOrderReflections;
		}
		if (Input.GetKeyDown(KeyCode.F2))
		{
			drawSecondOrderReflections = !drawSecondOrderReflections;
		}
		if (Input.GetKeyDown(KeyCode.F3))
		{
			drawHigherOrderReflections = !drawHigherOrderReflections;
		}
		if (Input.GetKeyDown(KeyCode.F4))
		{
			drawDiffractionPaths = !drawDiffractionPaths;
		}
	}
